package com.cenes.materialcalendarview;
...
import com.cenes.R;
import com.cenes.materialcalendarview.format.ArrayWeekDayFormatter;
import com.cenes.materialcalendarview.format.DateFormatTitleFormatter;
import com.cenes.materialcalendarview.format.DayFormatter;
import com.cenes.materialcalendarview.format.MonthArrayTitleFormatter;
import com.cenes.materialcalendarview.format.TitleFormatter;
import com.cenes.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public static final int INVALID_TILE_DIMENSION = 0;
    ...
    /**
     * Set a {@linkplain com.cenes.materialcalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.cenes.materialcalendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.cenes.materialcalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.cenes.materialcalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.cenes.materialcalendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.cenes.materialcalendarview.format.TitleFormatter)
     */
