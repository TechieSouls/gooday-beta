...
public class GatheringPreviewFragmentBkup extends CenesFragment {
    ...
    public static String TAG = "GatheringPreviewFragmentBkup";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_gathering_preview_bkup, container, false);
            ...
            switch (v.getId()) {
               ...
               /* case R.id.tv_rsvp_list_con:
                ...
                case R.id.tv_back_preview:
                    ...
                    /*getFragmentManager()
                            .beginTransaction()
                            .remove(GatheringPreviewFragmentBkup.this).attach(CreateGatheringFragment)
                            .commit();*/
                    break;
