...
import com.cenesbeta.materialcalendarview.format.MonthArrayTitleFormatter;
import com.cenesbeta.materialcalendarview.format.TitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain com.cenesbeta.materialcalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.cenesbeta.materialcalendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.cenesbeta.materialcalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.cenesbeta.materialcalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.cenesbeta.materialcalendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.cenesbeta.materialcalendarview.format.TitleFormatter)
     */
